// PROTOTYPE REFERENCE ONLY. This simulated review journey is not imported by the connected app.
...
import ChooseActivityModal from './ChooseActivityPrototypeModal'
import MarkUnmatchedDialog from './MarkUnmatchedPrototypeDialog'
import RequestClarificationModal from './RequestClarificationPrototypeModal'
...
export default function ReviewMatchPrototypeDrawer({ item, open, onClose, onAccept }: Props) {
