// PROTOTYPE REFERENCE ONLY. Clarification persistence has no connected contract yet.
...
export default function RequestClarificationPrototypeModal({ open, onClose, activityId }: Props) {
