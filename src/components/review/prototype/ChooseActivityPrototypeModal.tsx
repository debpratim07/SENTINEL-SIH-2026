// PROTOTYPE REFERENCE ONLY. This modal uses local sample activities.
...
export default function ChooseActivityPrototypeModal({ open, onClose, onSelect, currentActivityId }: Props) {
