import { Menu, Moon, Sun, Pause, Play } from 'lucide-react'
...
interface HeaderProps { reducedMotion:boolean; onToggleMotion:()=>void; osReduced:boolean; pageTitle:string; dark:boolean; onToggleDark:()=>void; onOpenProfile:()=>void; onOpenNavigation:()=>void }
export default function Header({dark,onToggleDark,onOpenProfile,onOpenNavigation,reducedMotion,onToggleMotion,osReduced,pageTitle}:HeaderProps){
